...
def submit_jobs(test_run):
    ...
    logdir = 'simulation/ardfa_l1h1_logs'
    pathlib.Path(logdir).mkdir(parents=True, exist_ok=True)
    savedir = '/work/pi_nick_umass_edu/ARVarDFA/simulation/ardfa_ARVar_fits_l1h1_2'
                ...
                for sigmafactor in sigmafactors:
                    for replicate in range(num_replicates):
                        ...
                        cmd = f'module load miniconda/22.11.1-1\n' \
                            ...
                            f'python dfa_sim_fit_one_withcondition_l1h1_2_replicate.py --sample_size {sample_size} --theta {theta} --condition {condition} --sigmafactor {sigmafactor} --replicate {replicate}'
